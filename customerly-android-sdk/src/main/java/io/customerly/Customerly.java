...
public class Customerly {
    ...
    @ColorInt
    private static final int DEF_WIDGET_COLOR_MALIBU_INT = 0xff65a9e7;//Blue Malibu

    @NonNull
    final IU_RemoteImageHandler _RemoteImageHandler = new IU_RemoteImageHandler();
    @NonNull
    ...
    @NonNull
    private String __PING__LAST_min_version = "0.0.0";
    private long __PING__next_ping_allowed = 0L;
    @ColorInt
    int __PING__LAST_widget_color;
    @Nullable
    String __PING__LAST_widget_background_url;
    boolean __PING__LAST_powered_by;
    @Nullable
    private String __PING__LAST_welcome_message_users, __PING__LAST_welcome_message_visitors;
    @Nullable
    IE_Admin[] __PING__LAST_active_admins;

    @NonNull
    JSONObject __PING__DeviceJSON = new JSONObject();

    @Nullable
    private ArrayList<Class<? extends Activity>> _DisabledActivities = null;
    @NonNull private final Object[] _DISABLED_ACTIVITIES_LOCK = new Object[0];
    @Nullable
    private Runnable _PendingRunnableForNotDisabledActivity = null;

    @Nullable
    private WeakReference<Activity> _CurrentActivity;
    @NonNull
    private final Application.ActivityLifecycleCallbacks __ActivityLifecycleCallbacks = new Application.ActivityLifecycleCallbacks() {
        private boolean paused = false, foreground = false;
        @NonNull
        private Runnable checkBackground = new Runnable() {
            @Override
            public void run() {
                            ...
                            __Handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (activity != null && (disabledActivities == null || !disabledActivities.contains(activity.getClass()))) {
                                        ...
                                        _PendingRunnableForNotDisabledActivity = new Runnable() {
                                            @Override
                                            public void run() {
                                                __Handler.postDelayed(new Runnable() {
                                                    @Override
    ...
    @NonNull
    private final PingResponseConverter __PING__response_converter__SurveyMessage = new PingResponseConverter(true, true),
    ...
    @NonNull
    private static final Customerly _Instance = new Customerly();
    ...
    interface __SOCKET__ITyping_listener {
        void onTypingEvent(long pConversationID, long account_id, boolean pTyping);
    }

    @Nullable
    __SOCKET__ITyping_listener __SOCKET__Typing_listener = null;
    @Nullable
    private String __SOCKET__Token = null, __SOCKET__Endpoint = null, __SOCKET__Port = null;
    @Nullable
    private String __SOCKET__CurrentConfiguration = null;
    private boolean __SOCKET__shouldBeConnected = false;
    @NonNull
    private final Runnable __SOCKET__ping = new Runnable() {
        @Override
        public void run() {
            if (Customerly.this.isSDKavailable()) {
                Customerly.this.__SOCKET__check();
                Socket socket = Customerly.this._Socket;
                if (socket != null) {
                    Activity activity = _CurrentActivity == null ? null : _CurrentActivity.get();
                    socket.emit(activity != null && activity instanceof SDKActivity ? SOCKET_EVENT__PING_ACTIVE : SOCKET_EVENT__PING);
                    Customerly.this.__Handler.postDelayed(Customerly.this.__SOCKET__ping, SOCKET_PING_INTERVAL);
                }
            }
        }
    };
...
//                            options.reconnectionDelayMax = 60000;
                            ...
                            if (socket != null) {
                                ...
                                socket.on(SOCKET_EVENT__TYPING, new Emitter.Listener() {
                                    @Override
                                    ...
                                    /*  {   client : {account_id: 82, name: "Gianni"},
                                            ...
                                            is_typing : "n" } */
                                                ...
                                                if (client != null) {
                                                    ...
                                                    if (account_id != -1L) {
                                                        try {
                                                            _DEV_log(String.format("SOCKET RX: %1$s -> %2$s", SOCKET_EVENT__TYPING, payloadJson.toString(1)));
                                                        } catch (JSONException ignored) {
                                                        }
                                                        boolean is_typing = "y".equals(payloadJson.optString("is_typing"));
                                                        payloadJson = payloadJson.getJSONObject("conversation");
                                                        if (payloadJson != null) {
                                                            IE_JwtToken token2 = _JwtToken;
                                                            if (token2 != null && token2._UserID != null && token2._UserID == payloadJson.getLong("user_id") && !payloadJson.optBoolean("is_note", false)) {
                                                                ...
                                                                __SOCKET__ITyping_listener listener = __SOCKET__Typing_listener;
                                ...
                                socket.on(SOCKET_EVENT__MESSAGE, new Emitter.Listener() {
                                    @Override
                                    public void call(Object... payload) {
                                        if (payload.length != 0) {
                                            try {
                                         ...
                                         */
                                                if (payloadJson.optBoolean("from_account")) {
                                                    try {
                                                        _log("Message received via socket");
                                                        _DEV_log(String.format("SOCKET RX: %1$s -> %2$s", SOCKET_EVENT__MESSAGE, payloadJson.toString(1)));
                                                    } catch (JSONException ignored) {
                                                    }
                                                    ...
                                                    if (token2 != null && token2._UserID != null && token2._UserID == socket_user_id
                                                        ...
                                                        new IApi_Request.Builder<ArrayList<IE_Message>>(IApi_Request.ENDPOINT_MESSAGE_NEWS)
                                                                .opt_converter(new IApi_Request.ResponseConverter<ArrayList<IE_Message>>() {
                                                                    @Nullable
                                                                    @Override
                                                                    public ArrayList<IE_Message> convert(@NonNull JSONObject pData) throws JSONException {
                                                                        return IU_Utils.fromJSONdataToList(pData, "messages", new IU_Utils.JSONObjectTo<IE_Message>() {
                                                                            @NonNull
                                                                            @Override
                                                                ...
                                                                .opt_receiver(new IApi_Request.ResponseReceiver<ArrayList<IE_Message>>() {
                                                                    @Override
                                                                    public void onResponse(@IApi_Request.ResponseState int responseState, @Nullable final ArrayList<IE_Message> new_messages) {
                                                                        if (responseState == IApi_Request.RESPONSE_STATE__OK && new_messages != null && new_messages.size() != 0) {
                                                                            Activity activity = _CurrentActivity == null ? null : _CurrentActivity.get();
                                                                            if (activity != null && _isEnabledFor(activity.getClass())) {
                                                                                if (activity instanceof SDKActivity) {
                                                                                    ((SDKActivity) activity).onNewSocketMessages(new_messages);
                                                                                } else if (_SupportEnabled) {
                                                                                    try {
                                                                                ...
                                                                                _PendingRunnableForNotDisabledActivity = new Runnable() {
                                                                                    ...
                                                                                    public void run() {
                                                                                        __Handler.postDelayed(new Runnable() {
                                                                                            ...
                                                                                            public void run() {
                                                                                                Activity p_activity = _CurrentActivity == null ? null : _CurrentActivity.get();
                                                                                                if (p_activity != null && _isEnabledFor(p_activity.getClass())) {
                                                                                                    if (p_activity instanceof SDKActivity) {
                                                                                ...
                                                                                };//Delay needed or popup is not showed
                                                                            }
                                                                        }
                                                                    }
                                                                })
    ...
    private synchronized void __PING__Start(@Nullable final io.customerly.Customerly.Callback pSuccessCallback, @Nullable final Callback pFailureCallback) {
        if (this._isConfigured()) {
            ...
            new IApi_Request.Builder<Void>(IApi_Request.ENDPOINT_PING)
                    ...
                    .opt_receiver(new IApi_Request.ResponseReceiver<Void>() {
                        @Override
                        public void onResponse(@IApi_Request.ResponseState int pResponseState, @Nullable Void pResponse) {
                            __ExecutingPing = false;
                            if (pResponseState == IApi_Request.RESPONSE_STATE__OK) {
    ...
    public interface Task {
        ...
        @CheckResult
        @NonNull
        Task successCallback(@Nullable Callback successCallback);
        ...
        @CheckResult
        @NonNull
        Task failureCallback(@Nullable Callback failureCallback);
    ...
    private abstract class __Task implements Task {
        @Nullable
        protected io.customerly.Customerly.Callback successCallback;
        @Nullable
        ...
        @CheckResult
        @NonNull
        public Task successCallback(@Nullable Callback successCallback) {
        ...
        @CheckResult
        @NonNull
        public Task failureCallback(@Nullable Callback failureCallback) {
    ...
    public final class RegisterUserTask extends __Task {
        ...
        @Nullable
        private JSONObject attributes, company;
        ...
        @CheckResult
        @NonNull
        public RegisterUserTask user_id(@NonNull String user_id) {
        ...
        @CheckResult
        @NonNull
        public RegisterUserTask name(@NonNull String name) {
            name = name.trim();
            if (name.length() != 0) {
                this.name = name;
            }
        ...
        @CheckResult
        @NonNull
        public RegisterUserTask attributes(@NonNull HashMap<String, Object> attributes) throws IllegalArgumentException {
        ...
        @CheckResult
        @NonNull
        public RegisterUserTask company(@NonNull HashMap<String, Object> company) throws IllegalArgumentException {
        ...
        protected void _executeTask() {
            final SharedPreferences pref = _SharedPreferences;
            if (pref != null && Patterns.EMAIL_ADDRESS.matcher(this.email).matches()) {
                new IApi_Request.Builder<Void>(IApi_Request.ENDPOINT_PING)
                        .opt_converter(new IApi_Request.ResponseConverter<Void>() {
                            @Nullable
                            @Override
                            public Void convert(@NonNull JSONObject root) throws JSONException {
                                SharedPreferences.Editor editor = pref.edit()
                                        .putString(PREF_CURRENT_EMAIL, email)
                                        .putString(PREF_CURRENT_ID, user_id);
                                if (company != null) {
                                    try {
                                        editor.putString(PREF_CURRENT_COMPANY_INFO,
                                                new JSONObject()
                                                        .put("company_id", company.getString("company_id"))
                                                        .put("name", company.getString("name"))
                                                        .toString());
                                    } catch (JSONException ignored) {
                                    }
                                } else {
                        ...
                        .opt_receiver(new IApi_Request.ResponseReceiver<Void>() {
                            @Override
                            public void onResponse(@IApi_Request.ResponseState int responseState, @Nullable Void _void) {
    ...
    public static class CompanyBuilder {
        @NonNull
        private final HashMap<String, Object> company = new HashMap<>();
        ...
        @NonNull
        @CheckResult
        public CompanyBuilder put(@NonNull String key, @NonNull String value) {
        ...
        @NonNull
        @CheckResult
        public CompanyBuilder put(@NonNull String key, int value) {
        ...
        @NonNull
        @CheckResult
        public CompanyBuilder put(@NonNull String key, byte value) {
            if (!("company_id".equals(key) || "name".equals(key))) {
                this.company.put(key, value);
            }
            return this;
        ...
        @NonNull
        @CheckResult
        public CompanyBuilder put(@NonNull String key, long value) {
            if (!("company_id".equals(key) || "name".equals(key))) {
                this.company.put(key, value);
            }
            return this;
        ...
        @NonNull
        @CheckResult
        public CompanyBuilder put(@NonNull String key, double value) {
            if (!("company_id".equals(key) || "name".equals(key))) {
                this.company.put(key, value);
            }
            return this;
        ...
        @NonNull
        @CheckResult
        public CompanyBuilder put(@NonNull String key, float value) {
            if (!("company_id".equals(key) || "name".equals(key))) {
                this.company.put(key, value);
            }
            return this;
        ...
        @NonNull
        @CheckResult
        public CompanyBuilder put(@NonNull String key, char value) {
            if (!("company_id".equals(key) || "name".equals(key))) {
                this.company.put(key, value);
            }
            return this;
        ...
        @NonNull
        @CheckResult
        public CompanyBuilder put(@NonNull String key, boolean value) {
            if (!("company_id".equals(key) || "name".equals(key))) {
                this.company.put(key, value);
            }
            return this;
    ...
    public final class SetCompanyTask extends __Task {
        @NonNull
        private final JSONObject company;
    ...
    @CheckResult
    @NonNull
    public RegisterUserTask registerUser(@NonNull String email) {
    ...
    @CheckResult
    @NonNull
    public SetAttributesTask setAttributes(@NonNull HashMap<String, Object> pAttributes) throws IllegalArgumentException {
    ...
    @CheckResult
    @NonNull
    public SetCompanyTask setCompany(@NonNull HashMap<String, Object> pCompany) throws IllegalArgumentException {
                ...
                if (token != null && (token.isUser() || token.isLead())) {
                    ...
                    new IApi_Request.Builder<IE_Message>(IApi_Request.ENDPOINT_EVENT_TRACKING)
                            ...
                            .opt_receiver((new IApi_Request.ResponseReceiver<IE_Message>() {
                                @Override
                                public void onResponse(@IApi_Request.ResponseState int pResponseState, @Nullable IE_Message pResponse) {
                                    Customerly.this._log("Customerly.trackEvent completed successfully for event " + pEventName);
                                }
                            }))
                            .start();
                } else {
    ...
    public void disableOn(Class<? extends Activity> activityClass) {
        synchronized (this._DISABLED_ACTIVITIES_LOCK) {
            if (this._DisabledActivities == null) {
                this._DisabledActivities = new ArrayList<>(1);
            }
            this._DisabledActivities.add(activityClass);
        }
    }
    ...
    public void enableOn(Class<? extends Activity> activityClass) {
        synchronized (this._DISABLED_ACTIVITIES_LOCK) {
            if (this._DisabledActivities != null) {
                this._DisabledActivities.remove(activityClass);
            }
        }
    }
    public boolean _isEnabledFor(Class<? extends Activity> activityClass) {
        synchronized (this._DISABLED_ACTIVITIES_LOCK) {
            return this._DisabledActivities == null || !this._DisabledActivities.contains(activityClass);
        }
    }
